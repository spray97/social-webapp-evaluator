  ...
  try {
    ...
    if (sheet2Data && sheet2Data.content) {
      ...
      var relevancePrompt =
        ...
        '출력 형식을 반드시 아래와 같이 지키세요:\n' +
        '첫 번째 줄: <<높음>>, <<보통>>, <<낮음>> 중 정확히 하나만 단독으로 작성 (다른 텍스트 없이)\n' +
        '두 번째 줄: 3차와 4차 수행평가의 연관성 근거를 3문장 이상 한국어로 서술하세요. ' +
        '마크다운(번호·볼드 등) 없이 한 문단으로 작성하고, 구체적인 기능·주제어를 언급하여 충분히 설명하세요.\n\n' +
